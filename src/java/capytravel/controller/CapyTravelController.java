    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action == null) {
                ...
                //chuyen huong ve servlet LoginController
            } else if (action.equals("login")) {
                url = LOGIN_CONTROLLER;
                
              //chuyen huong ve servlet User(trang admin) 
              // actionUser hien tai chi la minh hoa, chua phai name chinh thuc
            } else if (action.equals("actionUser")) {
                url = USER_CONTROLLER;
            }
